...
const Trips = () => {
  ...
  const handleReviewSubmit = async () => {
    try {
      ...
      const response = await postDataById("reviews", reviewPayload, token, selectedTripId);
  ...
  return (
    <Box sx={{ padding: isMobile ? 2 : 4 }}>
              ...
              >
                ...
                <Card>
                  <CardContent>
                    ...
                    {isToday(trip.endDate) && !userReviews[trip.listingId._id] && (
                    <Button
                    sx={{marginTop: "2px"}}
                      variant="outlined"
                      color="primary"
                      onClick={() => handleOpenReviewModal(trip.listingId._id)}
                    >
                      Give Review
                    </Button>
                  )}

                  {userReviews[trip.listingId._id] && (
                    <Typography variant="body2" color="text.secondary">
      ...
      <Dialog open={reviewModalOpen} onClose={handleCloseReviewModal}   sx={{ "& .MuiDialog-paper": { width: "600px", maxWidth: "90%" } }}>

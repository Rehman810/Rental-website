...
const resources = {
  en: { common: enCommon, homepage: enHomepage, listing: enListing, booking: enBooking, navbar: enNavbar, footer: enFooter, translation: enTranslation },
  ur: { common: urCommon, homepage: urHomepage, listing: urListing, booking: urBooking, navbar: urNavbar, footer: urFooter, translation: urTranslation },
  ar: { common: arCommon, homepage: arHomepage, listing: arListing, booking: arBooking, navbar: arNavbar, footer: arFooter, translation: arTranslation },
  de: { common: deCommon, homepage: deHomepage, listing: deListing, booking: deBooking, navbar: deNavbar, footer: deFooter, translation: deTranslation },
  fr: { common: frCommon, homepage: frHomepage, listing: frListing, booking: frBooking, navbar: frNavbar, footer: frFooter, translation: frTranslation },
  tr: { common: trCommon, homepage: trHomepage, listing: trListing, booking: trBooking, navbar: trNavbar, footer: trFooter, translation: trTranslation },
  zh: { common: zhCommon, homepage: zhHomepage, listing: zhListing, booking: zhBooking, navbar: zhNavbar, footer: zhFooter, translation: zhTranslation },
};
...
i18n
  ...
  .init({
    ...
    ns: ["common", "homepage", "listing", "booking", "translation", "footer", "navbar"],
    defaultNS: "common",
    resources,
    interpolation: {
      escapeValue: false, 

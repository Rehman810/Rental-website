          ...
          >
            <CardContent sx={{ padding: 3 }}>
              ...
              <Typography variant="body2" sx={{ mt: 2 }}>
                <strong>Weekday Price:</strong> Rs {weekDayPrice} / night
              </Typography>
              <Typography variant="body2" sx={{ mt: 1 }}>
                <strong>Weekend Price:</strong> Rs {weekendDayPrice} / night
              </Typography>
              <Typography variant="body1" sx={{ mt: 2 }}>
                <strong>Total for {numofDays} nights:</strong> Rs{" "}
              ...
              >
                Weekdays are from Monday to Thursday, while the weekend includes

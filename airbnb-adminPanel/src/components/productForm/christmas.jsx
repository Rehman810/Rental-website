...
export default function ChristmasFields({ sizes, stock, initialValues }) {
      ...
      <Grid item xs={12} md={6}>
        <TextField
          {...register("review", {
            ...
            min: {
              value: 0,
              message: "Review must be at least 0",
            },
            max: {
              value: 5,
              message: "Review must be 5 or below",
            },
          })}
          label="Review"
          type="number"
      ...
      {initialValues._id && (
        ...
        <Grid item xs={12} md={6}>
          <FormControl margin="normal" fullWidth>
            ...
            <Select
              {...register("subCategoryChristmas")}
              labelId="subCategory-label"
              defaultValue={initialValues.category || ""}
              error={!!errors.subCategory}
              onChange={(event) => setValue("subCategoryChristmas", event.target.value)}
            >
              <MenuItem value="">
                <em>None</em>
              </MenuItem>
              {subcategory.map((stockItem) => (
                <MenuItem key={stockItem} value={stockItem}>
                  {stockItem}
                </MenuItem>
              ))}
